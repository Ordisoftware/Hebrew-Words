...
static partial class AppTranslations
{
  ...
  {
    [Language.EN] = "Verses by update date - {0} found out of {1}",
  ...
  static public readonly TranslationsDictionary RepairELS50 = new()
  {
    [Language.EN] = "ELS50 verses were incorrectly generated by a previous version. The software will reconstruct the sequences for all chapters.",
    [Language.FR] = "Les versets ELS50 ont été incorrectement générés par une version antérieure. Le logiciel va reconstruire les séquences pour tous les chapitres."
  };
